"""
 @author saozd
 @project pytonworkspace InterArea
 @date 19 Kas 2023
 <p>
 @description:
"""
...
resized = cv2.resize(gray_original, (20, 20), interpolation=cv2.INTER_AREA)
...
# Excel'e yazdır
df_resized.to_excel("resized_20x20_inter_area.xlsx", index=False)
