...
# def red_histogram():
#     global image
#     # Resmin kırmızı histogramını hesapla
#     plt.clf()
...
#     canvas.draw()
#     canvas.get_tk_widget().grid(row=3, column=4, padx=5, pady=5, sticky="nsew", rowspan=1, columnspan=1)
...
def red_histogram():
    ...
    # Resmin kırmızı histogramını hesapla gri ch 0
    red_hist = cv2.calcHist([convertedImage], [2], None, [256], [0, 256])
    ...
    #
    # # Gri tonlamalı histogramı hesapla
